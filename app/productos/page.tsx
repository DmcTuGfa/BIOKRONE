...
export default function ProductosPage() {
  ...
  // Lee el param de la URL sin useSearchParams
  useEffect(() => {
        ...
        <section className="py-8 border-b border-border">
          <div className="container mx-auto px-4">
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { value: "all",              label: "Todos",          desc: "Ver catálogo completo",        icon: <Leaf   className="h-5 w-5 text-primary" />,                          iconBg: "bg-primary/10",    count: categoryStats.all },
        ...
        <section className="py-12 bg-primary/5 border-t border-border">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
              Nuestro equipo de expertos está listo para ayudarte a elegir los productos ideales.
            </p>
